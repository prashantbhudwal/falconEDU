...
export const url = {
  teacher: {
    ...
    settings: {
      profile: `${baseUrl}/teacher/profile`,
      tools: `/preferences`,
      training: `${getTeacherHomeURL()}/teacher-training/gallery`,
      avatar: `${getTeacherHomeURL()}/teacher-preferences/`,
      notifications: `${getTeacherHomeURL()}/notifications`,
    },
