  ...
  return (
    <div className="join fixed bottom-3 w-6/12 bg-base-100 p-1 shadow-sm shadow-base-100">
      <input
        ...
        className="join-item textarea textarea-bordered textarea-md h-10 max-h-48 w-full resize-none overflow-y-hidden bg-slate-900 text-base text-slate-400 shadow-accent placeholder:text-sm placeholder:text-slate-500"
        placeholder={
          !!selectedBlock
