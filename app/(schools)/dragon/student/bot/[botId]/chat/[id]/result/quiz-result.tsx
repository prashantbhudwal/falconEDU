...
import { getGoalAssessmentResult } from "@/app/(schools)/dragon/teacher/class/[classId]/(tasks)/[taskId]/ai-test/responses/individual-response/[attemptId]/report";
import { Separator } from "@/components/ui/separator";
import { db } from "@/lib/routers";
import { GoalAssessmentResult } from "@prisma/client";
import { memoize } from "lodash";
import { Suspense } from "react";
import { getColorForResult } from "@/app/(schools)/dragon/teacher/class/[classId]/(tasks)/[taskId]/ai-test/responses/individual-response/[attemptId]/report";
